...
namespace TriceHelix.GenericBurstJobs.Editor
{
    internal static class CodeHelper
    {
        ...
        internal static string GenerateRegistryScript(string[] resolvedTypeStrings, int numUniqueJobs)
        {
            ...
            script.AppendLine("// PLEASE DO NOT EDIT THIS FILE MANUALLY - RUN THE SOURCE GENERATOR TO REFRESH IT OR TO FIX ANY ERRORS");
            script.AppendLine("// MAKE SURE YOU DELETE OLD VERSIONS OF THIS FILE WHEN CHANGING THE OUTPUT DESTINATION IN THE SETTINGS");
            ...
            script.AppendLine($"// Generated on {time.ToShortDateString()} @ {time.ToLongTimeString()} for application version {Application.version}");
